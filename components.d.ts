...
declare module '@vue/runtime-core' {
  export interface GlobalComponents {
    ...
    NavManu: typeof import('./src/components/nav-manu/src/nav-manu.vue')['default']
    NavUserInfo: typeof import('./src/components/nav-header/comps/nav-user-info.vue')['default']
